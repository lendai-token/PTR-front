...
import { setCityFrom } from "./homeSlice";
import { setCityFromName } from "./homeSlice";
...
const DropdownItems = (props: any) => {
  ...
  const handleChange = (e: any) => {
    props.onCityFromChange(e.target.value);
  ...
  const selectItem = (item: any) => {
    dispatch(setCityFrom(item.zipcode));
    dispatch(setCityFromName(item.name));
    props.onCityFromChange(item.name);
