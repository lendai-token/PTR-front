...
const Signin = () => {
  ...
  if (isDesktop) {
    content = (
      <>
        <div className="user-signin-page"></div>
            ...
            <Box sx={{maxWidth: '460px', margin: 'auto'}}>
              <Box sx={{borderRadius: '24px'}}>
                  <Box sx={{
                      ...
                      <Typography component="h1" variant="h5" style={{fontSize: '18px', marginBottom: '10px', color: '#212121'}}>
                          WELCOME BACK 
                      </Typography>
                      <Typography component="h1" variant="h5" style={{fontSize: '35px', color: '#212121'}}>
                          Log In to your Account
                      </Typography>
                  </Box>
