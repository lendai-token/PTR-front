...
import vectorImage from '../../assets/imgs/landing/vector.png';
import locationImage from '../../assets/imgs/landing/location.png';
...
const SearchBar = () => {
    ...
    const [selectedJobLocation, setSelectedJobLocation] = useState("State Location");
    ...
    const selectItemJob = (job: any) => {
        setSelectedJobTitle(job.name);
        setVisibleJob(false);
      };
    ...
    const selectItemLocation = (item: any) => {
        setSelectedJobLocation(item.name);
        setVisibleLocation(false);
    };
    ...
    if (isDesktop) {
            ...
            <div className="mx-[20px] 2xl:mx-[50px]">
                <div className="grid grid-cols-5">
                    <div className="col-span-4 grid grid-cols-4 bg-white border-[1px] rounded-[3px] h-[54px]">
                        <div tabIndex={0} className="col-span-1 flex items-center h-[40px] border-r-[1px] border-grey-300 mt-[6px]">
                            <button 
                                className="text-[14px] text-grey-300 p-4 font-normal w-full flex justify-center items-center"
                                onClick={() => {
                                    setVisibleJob(true);
                                }}
                            >
                                <span className="pr-1"><img src={arrowDown} alt="" /></span>
                                <span>Job title</span>
                            </button>
                        </div>
                        <div className="col-span-3 relative">
                            <input type="text" className="absolute top-2/4 search-input-bar text-[14px] font-normal" placeholder="Search all job" />
                            <span className="enlarger-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.65063 0C13.4205 0 17.3004 3.87986 17.3004 8.64974C17.3004 10.9002 16.4367 12.9527 15.0235 14.4931L17.8044 17.2681C18.0646 17.5284 18.0655 17.9494 17.8053 18.2097C17.6756 18.3411 17.5041 18.406 17.3336 18.406C17.1639 18.406 16.9934 18.3411 16.8628 18.2114L14.0484 15.4049C12.5679 16.5905 10.6906 17.3004 8.65063 17.3004C3.88075 17.3004 0 13.4196 0 8.64974C0 3.87986 3.88075 0 8.65063 0ZM8.65063 1.33237C4.61533 1.33237 1.33237 4.61444 1.33237 8.64974C1.33237 12.685 4.61533 15.968 8.65063 15.968C12.685 15.968 15.968 12.685 15.968 8.64974C15.968 4.61444 12.685 1.33237 8.65063 1.33237Z" fill="black"/>
                                </svg>
                    ...
                    <div className="col-span-1 pl-2 text-[20px] text-black relative">
                        <div className="h-full">
                            <button 
                                className="text-[14px] text-grey-300 font-normal p-4 bg-white w-full rounded-[3px] h-[54px] flex justify-center items-center"
                                onClick={() => {
                ...
                <div className="absolute left-2/4 top-[50px] -translate-x-2/4 w-full">
                    <span className="text-[17px] font-normal no-italic">Capture the attention of your future employer - </span>
                    <span>
                        <Link to="/signup" className="underline hover:no-underline text-[17px] font-bold no-italic">
                            CREATE YOUR PROFILE
                        </Link>
                    </span>
                </div>
        ...
        content = (
            <div className="mobile-search-bar">
                <div className="absolute w-full top-[485px] px-[9px] ">
                    <div className="bg-[white] rounded-[56px] h-[54px]">
                        <span className="mt-[18px] ml-[24px] float-left">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.65063 0C13.4205 0 17.3004 3.87986 17.3004 8.64974C17.3004 10.9002 16.4367 12.9527 15.0235 14.4931L17.8044 17.2681C18.0646 17.5284 18.0655 17.9494 17.8053 18.2097C17.6756 18.3411 17.5041 18.406 17.3336 18.406C17.1639 18.406 16.9934 18.3411 16.8628 18.2114L14.0484 15.4049C12.5679 16.5905 10.6906 17.3004 8.65063 17.3004C3.88075 17.3004 0 13.4196 0 8.64974C0 3.87986 3.88075 0 8.65063 0ZM8.65063 1.33237C4.61533 1.33237 1.33237 4.61444 1.33237 8.64974C1.33237 12.685 4.61533 15.968 8.65063 15.968C12.685 15.968 15.968 12.685 15.968 8.64974C15.968 4.61444 12.685 1.33237 8.65063 1.33237Z" fill="black"/>
                            </svg>
                        </span>
                        <input type="text" className="mobile-search-input-bar w-[80%] text-[20px] font-normal mt-[12px]" placeholder="Search all job"/>
                    </div>
                </div>
                <div className="relative">
                    <button 
                        className="bg-[#374957] h-[54px] mt-[10px] text-[18px] text-grey-300 p-4 font-normal w-full flex justify-start items-center pl-[30px]"
                        onClick={() => {
                            setVisibleJob(!visibleJob);
                        }}
                    >
                        <span className="pr-6"><img src={vectorImage} alt="" /></span>
                        <span className="text-[20px] text-[white]">{selectedJobTitle}</span>
                    </button>
                    <div className="flex flex-row justify-center items-center ">
                        {visibleJob && (
                        <ul className="pt-[15px] text-start h-[228px] text-[14.66px] font-[700] text-[#374957]">
                            {jobList && jobList.map((x: any) => (
                                <li
                                key={x.id}
                                onClick={() => selectItemJob(x)}
                    ...
                    <div className="bg-[#374957] h-[54px] mt-[10px]">
                        <button 
                            className="text-[14px] text-grey-300 font-normal p-4 w-full rounded-[3px] h-[54px] flex justify-start items-center pl-[30px]"
                            onClick={() => {
                                setVisibleLocation(!visibleLocation);
                            }}
                        >
                            <span className="pr-6"><img src={locationImage} alt="" /></span>
                            <span className="text-[20px] text-[white]">{selectedJobLocation}</span>
                        </button>
                    </div>
                    <div ref={dropdownRef} className="px-[20px] mt-[10px]">
                        {visibleLocation && (
                        <ul className="pl-[20px] text-[21.7px] font-[400] text-[#374957] list-disc grid grid-cols-2 text-start">
                            {locationList.length === 0 && (
                                <li key="zxc" className="dropdown_item">
                                    no result
                                </li>
                            ...
                            {locationList && locationList.map((x: any) => (
                                ...
                                className=""
                                >
                                <div className="cursor-pointer	">{x.name}</div>
                                </li>
                            ))}
                        </ul>)}
                    </div>
