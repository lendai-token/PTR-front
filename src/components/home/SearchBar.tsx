    ...
    if (isDesktop) {
        ...
        content = (
            <div className="mx-[20px] 2xl:mx-[50px]">
                ...
                <div className="absolute left-2/4 top-[50px] -translate-x-2/4 w-full">
                    <span className="text-[19px] font-normal no-italic">Capture the attention of your future employer - </span>
                    <span>
                        <Link to="/signup" className="underline hover:no-underline text-[19px] font-bold no-italic">
                            CREATE YOUR PROFILE
                        </Link>
                    </span>
                </div>
